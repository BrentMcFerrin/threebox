 ...
 * @property {(THREE.FrontSide|BackSide|DoubleSide)} [side=THREE.FrontSide] - Which side to apply the material.
 * @property {(THREE.RepeatWrapping|ClampToEdgeWrapping|MirroredRepeatWrapping)} [wrap=THREE.RepeatWrapping] - What type of wrapping to apply for textures.
		...
		for ( const prop in mat ) {
			...
			switch ( prop.toLowerCase() ) {
				...
				case 'kd':
					...
					params.color = THREE.ColorManagement.colorSpaceToWorking( new THREE.Color().fromArray( value ), THREE.SRGBColorSpace );
				...
				case 'ks':
					...
					params.specular = THREE.ColorManagement.colorSpaceToWorking( new THREE.Color().fromArray( value ), THREE.SRGBColorSpace );
				...
				case 'ke':
					...
					params.emissive = THREE.ColorManagement.colorSpaceToWorking( new THREE.Color().fromArray( value ), THREE.SRGBColorSpace );
