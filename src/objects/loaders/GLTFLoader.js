 ...
 * and/or cameras.
 *
 * `GLTFLoader` uses {@link THREE.ImageBitmapLoader} whenever possible. Be advised that image bitmaps are not
 ...
 *
 * @private
 * @param {Object<string, THREE.Material>} cache
 ...
 *
 * @private
 * @param {THREE.Object3D|THREE.Material|THREE.BufferGeometry|Object|THREE.AnimationClip} object
...
class GLTFParser {
	 ...
	 * @return {Promise<THREE.Group|THREE.Mesh|THREE.SkinnedMesh|THREE.Line|THREE.Points>}
	 */
	loadMesh( meshIndex ) {
...
/**
 * THREE.Loader result of `GLTFLoader`.
 *
 * @typedef {Object} GLTFLoader~LoadObject
 * @property {Array<THREE.AnimationClip>} animations - An array of animation clips.
 ...
 * @property {THREE.Group} scene - The default scene.
 * @property {Array<THREE.Group>} scenes - glTF assets might define multiple scenes.
