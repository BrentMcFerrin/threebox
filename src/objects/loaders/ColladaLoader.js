...
class ColladaLoader extends THREE.Loader {
	 ...
	 * @param {function({scene:THREE.Group,animations:Array<THREE.AnimationClip>,kinematics:Object})} onLoad - Executed when the loading process has been finished.
	 ...
	 * @return {?{scene:THREE.Group,animations:Array<THREE.AnimationClip>,kinematics:Object}} An object representing the parsed asset.
	 */
	parse( text, path ) {
		...
		function buildMaterial( data ) {
			...
			THREE.ColorManagement.colorSpaceToWorking( material.color, THREE.SRGBColorSpace );
			if ( material.specular ) THREE.ColorManagement.colorSpaceToWorking( material.specular, THREE.SRGBColorSpace );
			if ( material.emissive ) THREE.ColorManagement.colorSpaceToWorking( material.emissive, THREE.SRGBColorSpace );
			...
			for ( let i = 0, l = xml.childNodes.length; i < l; i ++ ) {
				...
				switch ( child.nodeName ) {
					...
					case 'color':
						...
						THREE.ColorManagement.colorSpaceToWorking( data.color, THREE.SRGBColorSpace );
						break;
...
module.exports = exports = ColladaLoader;
